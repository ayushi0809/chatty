...
const page = async ({params} : PageProps) => {
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)] -mt-16 ml-2'>
    <div className='flex sm-items-cnter justify-between py-3 border-b-2 border-gray-200'>
      <div className='relative flex items-center space-x-4'>
        ...
        <div className='flex flex-col leading-tight'>
          ...
          <span className='text-sm text-gray'>{chatPartner.email}</span>
        </div>
      </div>
    </div>
